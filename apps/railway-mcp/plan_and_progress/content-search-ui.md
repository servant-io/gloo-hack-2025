...
- Implemented expandable preview overlay with embedded video playback launched directly from carousel cards (detail sidebar removed to keep layout stable). Added loading skeleton state for carousel cards. Verification still pending due to sandbox build limits.
